...
lines.length = 500;  //size of line array
...
display() // run continously in draw
{
...
newLine.opacity = random(100, 255);
newLine.stroke = random(0, 255);
newLine.strokeWeight = random(0.5, 3);
